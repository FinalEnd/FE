...
class ParseAbleObject
{
	...
	protected function parseBBCode($String)
	{
		...
		$String=str_replace("[img]", "<img style='max-width:1024px;width:expression(document.body.clientWidth > 1024? \"1024px\": \"auto\" );' src=\"",$String);
