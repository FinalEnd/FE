<div id="Panel" style="position:relative;bottum:0px;margin:auto;padding:0px;width:1280px;height:100px;background-image:url(./images/design/Panel.png);background-repeat:no-repeat">
...
<div style="position:relative;top:42px;left:50px">

<select style="width:135px;" onchange="window.location.href='index.php?Section=ChangeActivePlanet&amp;D=<?php echo $this->Section;?>&amp;cb_Planet='+this.value" name="cb_Planet" size="" >
<?php
...
<table border="0" class="PanelRessourceTable" style="position:relative;top:-33px;left:325px">
<tr>
