...
class StateOverload extends State implements i_CollectionElement 
{
	protected $Id;
	protected $s_Name; 
	...
	{
		$Unit->setHealts($Unit->getHealts()-$Unit->getHealts(tue)*0.15);
		$Unit->setDMG($Unit->getDMG()+$Unit->getDMG()*0.15);
	}
